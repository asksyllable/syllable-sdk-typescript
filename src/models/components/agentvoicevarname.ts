...
export const AgentVoiceVarName = {
  ...
  CartesiaSkylar: "cartesia:Skylar",
  CartesiaDaniel: "cartesia:Daniel",
  CartesiaLinda: "cartesia:Linda",
  CartesiaCorey: "cartesia:Corey",
  CartesiaEmma: "cartesia:Emma",
  CartesiaXimena: "cartesia:Ximena",
  CartesiaFernanda: "cartesia:Fernanda",
  CartesiaEmilio: "cartesia:Emilio",
  CartesiaMarta: "cartesia:Marta",
  CartesiaMateo: "cartesia:Mateo",
  CartesiaMinji: "cartesia:Minji",
  CartesiaHaeun: "cartesia:Haeun",
  CartesiaTaehyun: "cartesia:Taehyun",
  CartesiaJaewon: "cartesia:Jaewon",
  CartesiaHua: "cartesia:Hua",
  CartesiaLiu: "cartesia:Liu",
  CartesiaXia: "cartesia:Xia",
  CartesiaSuda: "cartesia:Suda",
} as const;
/**
 * The variable name of an agent voice (used when processing messages).
 */
