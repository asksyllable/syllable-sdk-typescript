...
export type OutboundCampaignListRequest = {
  /**
...
/** @internal */
export const OutboundCampaignListRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const OutboundCampaignListRequest$outboundSchema: z.ZodType<
  OutboundCampaignListRequest$Outbound,
  z.ZodTypeDef,
  OutboundCampaignListRequest
> = z.object({
  page: z.nullable(z.number().int()).optional(),
...
export function outboundCampaignListRequestToJSON(
  ...
  return JSON.stringify(
    OutboundCampaignListRequest$outboundSchema.parse(
      outboundCampaignListRequest,
    ),
  );
}
...
export function outboundCampaignListRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => OutboundCampaignListRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OutboundCampaignListRequest' from JSON`,
  );
}
