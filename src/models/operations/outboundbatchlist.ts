...
export type OutboundBatchListRequest = {
  /**
   ...
   */
  searchFields?: Array<components.BatchProperties> | undefined;
  /**
   ...
   */
  orderBy?: components.BatchProperties | null | undefined;
  /**
   ...
   */
  fields?: Array<components.BatchProperties> | null | undefined;
  /**
...
/** @internal */
export const OutboundBatchListRequest$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  search_fields: z.array(components.BatchProperties$inboundSchema).optional(),
  search_field_values: z.array(z.string()).optional(),
  order_by: z.nullable(components.BatchProperties$inboundSchema).optional(),
  order_by_direction: z.nullable(components.OrderByDirection$inboundSchema)
    .optional(),
  fields: z.nullable(z.array(components.BatchProperties$inboundSchema))
    .optional(),
...
/** @internal */
export const OutboundBatchListRequest$outboundSchema: z.ZodType<
  OutboundBatchListRequest$Outbound,
  z.ZodTypeDef,
  OutboundBatchListRequest
> = z.object({
  page: z.nullable(z.number().int()).optional(),
  limit: z.number().int().default(25),
  searchFields: z.array(components.BatchProperties$outboundSchema).optional(),
  searchFieldValues: z.array(z.string()).optional(),
  orderBy: z.nullable(components.BatchProperties$outboundSchema).optional(),
  orderByDirection: z.nullable(components.OrderByDirection$outboundSchema)
    .optional(),
  fields: z.nullable(z.array(components.BatchProperties$outboundSchema))
    .optional(),
...
export function outboundBatchListRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => OutboundBatchListRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OutboundBatchListRequest' from JSON`,
  );
}
