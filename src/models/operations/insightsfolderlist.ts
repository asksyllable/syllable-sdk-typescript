...
export type InsightsFolderListRequest = {
  /**
   ...
   */
  searchFields?: Array<components.InsightsFolderProperties> | undefined;
  /**
   ...
   */
  orderBy?: components.InsightsFolderProperties | null | undefined;
  /**
   ...
   */
  fields?: Array<components.InsightsFolderProperties> | null | undefined;
  /**
...
/** @internal */
export const InsightsFolderListRequest$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  search_fields: z.array(components.InsightsFolderProperties$inboundSchema)
    .optional(),
  search_field_values: z.array(z.string()).optional(),
  order_by: z.nullable(components.InsightsFolderProperties$inboundSchema)
    .optional(),
  order_by_direction: z.nullable(components.OrderByDirection$inboundSchema)
    .optional(),
  fields: z.nullable(z.array(components.InsightsFolderProperties$inboundSchema))
    .optional(),
...
/** @internal */
export const InsightsFolderListRequest$outboundSchema: z.ZodType<
  InsightsFolderListRequest$Outbound,
  z.ZodTypeDef,
  InsightsFolderListRequest
> = z.object({
  page: z.nullable(z.number().int()).optional(),
  limit: z.number().int().default(25),
  searchFields: z.array(components.InsightsFolderProperties$outboundSchema)
    .optional(),
  searchFieldValues: z.array(z.string()).optional(),
  orderBy: z.nullable(components.InsightsFolderProperties$outboundSchema)
    .optional(),
  orderByDirection: z.nullable(components.OrderByDirection$outboundSchema)
    .optional(),
  fields: z.nullable(
    z.array(components.InsightsFolderProperties$outboundSchema),
  ).optional(),
...
export function insightsFolderListRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => InsightsFolderListRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InsightsFolderListRequest' from JSON`,
  );
}
