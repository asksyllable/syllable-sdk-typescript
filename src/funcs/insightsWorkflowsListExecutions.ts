 ...
 */
export function insightsWorkflowsListExecutions(
  client: SyllableSDKCore,
  request: operations.InsightsWorkflowExecutionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ListResponseInsightWorkflowExecutionOutput,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.InsightsWorkflowExecutionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/api/v1/insights/workflows/{workflow_id}/executions",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "insights_workflow_executions",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      components.ListResponseInsightWorkflowExecutionOutput$inboundSchema,
    ),
