 ...
 * Get a prompt by ID
 */
export async function promptsGetById(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PromptsGetByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/prompts/{prompt_id}")(pathParams);
