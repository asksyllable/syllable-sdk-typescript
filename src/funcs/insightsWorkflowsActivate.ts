 ...
 */
export function insightsWorkflowsActivate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.InsightsWorkflowActivateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.InsightWorkflowActivate, {
    explode: true,
  });
