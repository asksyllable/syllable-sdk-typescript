 ...
 */
export function insightsWorkflowsListSessions(
  client: SyllableSDKCore,
  request: operations.InsightsWorkflowSessionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ListResponseWorkflowSessionRow,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.InsightsWorkflowSessionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/insights/workflows/{workflow_id}/sessions")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "insights_workflow_sessions",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListResponseWorkflowSessionRow$inboundSchema),
