 ...
 */
export function channelsTwilioNumbersChannelsTwilioNumbersA2pComplianceCheck(
  client: SyllableSDKCore,
  request: operations.ChannelsTwilioNumbersA2pComplianceCheckRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.A2pMessagingPathCheckResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChannelsTwilioNumbersA2pComplianceCheckRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.A2pMessagingPathCheckRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.A2pMessagingPathCheckResponse$inboundSchema),
