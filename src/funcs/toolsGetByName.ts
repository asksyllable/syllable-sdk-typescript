 ...
 */
export async function toolsGetByName(
  client: SyllableSDKCore,
  request: operations.ToolGetByNameRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.ToolDetailResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ToolGetByNameRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ToolDetailResponse$inboundSchema),
