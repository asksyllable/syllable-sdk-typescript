...
export function directoryDirectoryMemberHistory(
  ...
  Result<
    components.ListResponseDirectoryMemberHistoryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DirectoryMemberHistoryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/directory_members/{member_id}/history")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      components.ListResponseDirectoryMemberHistoryResponse$inboundSchema,
    ),
