 ...
 */
export async function channelsTwilioNumbersUpdate(
  client: SyllableSDKCore,
  request: operations.ChannelsTwilioNumbersUpdateRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.TwilioNumberUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChannelsTwilioNumbersUpdateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.TwilioNumberUpdateRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TwilioNumberUpdateResponse$inboundSchema),
