 ...
 */
export function sessionsTimelineGetById(
  client: SyllableSDKCore,
  request: operations.SessionTimelineGetByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SessionTimelineResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SessionTimelineGetByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SessionTimelineResponse$inboundSchema),
