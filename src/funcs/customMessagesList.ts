 ...
 */
export async function customMessagesList(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CustomMessagesListRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/custom_messages/")();
