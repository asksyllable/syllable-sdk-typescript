 ...
 */
export async function insightsFoldersGetById(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.InsightsFolderGetByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FolderDetails$inboundSchema),
