...
export async function conversationsList(
  ...
  Result<
    components.ListResponseConversation,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConversationsListRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/conversations/")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ListResponseConversation$inboundSchema),
