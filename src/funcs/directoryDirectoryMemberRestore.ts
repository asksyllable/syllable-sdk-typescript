 ...
 */
export function directoryDirectoryMemberRestore(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DirectoryMemberRestoreRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DirectoryMemberRestore, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v1/directory_members/{member_id}/restore")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["404", "409", "422", "4XX", "500", "5XX"],
