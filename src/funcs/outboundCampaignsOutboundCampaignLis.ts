 ...
 */
export async function outboundCampaignsOutboundCampaignLis(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OutboundCampaignLisRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "outbound_campaign_lis",
    oAuth2Scopes: [],
