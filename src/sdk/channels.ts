...
import { channelsChannelsTwilioNumbersCreateSomething } from "../funcs/channelsChannelsTwilioNumbersCreateSomething.js";
...
export class Channels extends ClientSDK {
   ...
   */
  async channelsTwilioNumbersCreateSomething(
    request: operations.ChannelsTwilioNumbersCreateSomethingRequest,
    options?: RequestOptions,
  ): Promise<components.TwilioNumberCreateResponse> {
    return unwrapAsync(channelsChannelsTwilioNumbersCreateSomething(
      this,
      request,
      options,
    ));
