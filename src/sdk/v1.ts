...
import { v1OutboundCampaignFetchAll } from "../funcs/v1OutboundCampaignFetchAll.js";
import { v1OutboundCampaignNew } from "../funcs/v1OutboundCampaignNew.js";
...
export class V1 extends ClientSDK {
  ...
  async outboundCampaignFetchAll(
    ...
    return unwrapAsync(v1OutboundCampaignFetchAll(
      this,
      request,
      options,
    ));
  ...
  async outboundCampaignNew(
    ...
    return unwrapAsync(v1OutboundCampaignNew(
      this,
      request,
      options,
    ));
