...
| `variables`                                                                                         | [components.AgentUpdateVariables](/sdk-docs/models/components/agentupdatevariables)                  | TRUE                                                                                  | Custom context variables for the conversation session. Should be prefixed with "vars.".             | {<br/>"vars.hospital": "Weill Cornell Medical Center"<br/>}                                         |
