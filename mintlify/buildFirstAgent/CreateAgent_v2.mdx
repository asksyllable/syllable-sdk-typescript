...
* **Session configuration**: You can use this section to set [other agent-level configuration values](/workspaces/SessionConfig). You can skip it for the tutorial.
...
* Create a [language group](/Resources/LanguageGroups), link it to your agent, and add the corresponding DTMF menu to the message to enable it to use different languages and voices