...
Click [here](https://docs.syllable.ai/Resources/res_WritePrompt) for more information on writing prompts for AI agents.

## Configure your prompt

![](/images/configure_prompt.jpg)
...
* **Select tools from dropdown menu:** Based on the tools available to your organization, you can select tools that give an agent using the prompt the ability to do useful work like schedule appointments or relay messages. (Note: you will have to reference these tools in the prompt in order for the agent to use them. Click [here](https://docs.syllable.ai/Resources/Tools) for more info.)