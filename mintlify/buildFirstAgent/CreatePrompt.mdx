...
Click [here](/Resources/res_WritePrompt.mdx) for more information on writing prompts for AI agents.
...
* **Select tools from dropdown menu:** Based on the tools available to your organization, you can select tools that give an agent using the prompt the ability to do useful work like schedule appointments or relay messages. (Note: you will have to reference these tools in the prompt in order for the agent to use them. Click [here](/Resources/Tools.mdx) for more info.)