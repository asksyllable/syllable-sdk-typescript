...
After you configure these parameters, your new Agent should be good to start using and interacting with. But that’s not all, if you want it to perform actual tasks with your system, you need to set up Tools.
