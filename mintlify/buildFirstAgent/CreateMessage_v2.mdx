...
* **Language menu tag button**: This button allows you to insert a language menu tag into the message. You can skip this for the tutorial, but if you want to know more, see the [language group docs](/Resources/LanguageGroups.mdx).
...
[(Full message docs)](/Resources/Messages.mdx)