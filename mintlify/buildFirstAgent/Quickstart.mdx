...
An Agent is composed of a [**prompt**](https://docs.syllable.ai/Resources/res_WritePrompt), a [**custom message**](https://docs.syllable.ai/Resources/Messages), and [**tools**](https://docs.syllable.ai/Resources/Tools). &#x20;
