...
The steps to create an interactable Agent on Syllable AI are to first write a prompt, then a custom message, then the Agent, and finally create a channel linked to the Agent.

An Agent is composed of a [**prompt**](https://docs.syllable.ai/Resources/res_WritePrompt), a [**custom message**](https://docs.syllable.ai/buildFirstAgent/CreateMessage), and [**tools**](https://docs.syllable.ai/Resources/Tools). &#x20;
