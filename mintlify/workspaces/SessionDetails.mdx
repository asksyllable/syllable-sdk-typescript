...
The Sessions details page is where you can do a deep dive on an individual session between an Agent and a customer. All of the previous information from the session list is also displayed on the sessions details page: date, time, agent, user, channel etc. 
