...
let value: SipConfiguration = {
  ...
  callInfoPlacement: "uri_parameters",
};
```
...
| `callInfoPlacement`                                                                                                                                          | *string*                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                           | Where to place call information during a transfer. Supported values are `uri_parameters`, `to_parameters`, `from_parameters`, or `sip_header:<header-name>`. | **Example 1:** uri_parameters<br/>**Example 2:** sip_header:P-Asserted-Identity                                                                              |