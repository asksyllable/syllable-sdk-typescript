...
| `metadata`                                                                                                                         | [components.SchemasTtsV1PronunciationsDictionaryMetadata](../../models/components/schemasttsv1pronunciationsdictionarymetadata.md) | :heavy_check_mark:                                                                                                                 | Audit metadata associated with a dictionary.                                                                                       |