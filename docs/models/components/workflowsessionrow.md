...
| `analyzedAt`                                                                                                                                      | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                     | :heavy_minus_sign:                                                                                                                                | When the workflow execution started processing this session; null while the row is still PENDING                                                  | 2026-09-26T00:00:00Z                                                                                                                              |
| `queuedAt`                                                                                                                                        | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                     | :heavy_check_mark:                                                                                                                                | When the session was queued for this workflow                                                                                                     | 2026-09-26T00:00:00Z                                                                                                                              |
