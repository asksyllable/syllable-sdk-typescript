...
| `asyncEnabled`                                                                          | *boolean*                                                                               | :heavy_minus_sign:                                                                      | Whether asynchronous mode is enabled for the conversation                               |
| `transferLegVoicemailDetectionEnabled`                                                  | *boolean*                                                                               | :heavy_minus_sign:                                                                      | Whether transfer leg voicemail detection is enabled                                     |
| `sipConfiguration`                                                                      | [components.SipConfiguration](../../models/components/sipconfiguration.md)              | :heavy_minus_sign:                                                                      | SIP routing configuration applied when transferring calls on this channel               |