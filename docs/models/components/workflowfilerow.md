...
let value: WorkflowFileRow = {
  ...
  analyzedAt: new Date("2026-09-16T00:00:00Z"),
  queuedAt: new Date("2026-09-16T00:00:00Z"),
  status: "PENDING",
...
| `filename`                                                                                                                                                   | *string*                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                           | Name of the uploaded file; null only when the file is entirely deleted                                                                                       | customer-complaints.wav                                                                                                                                      |
| `analyzedAt`                                                                                                                                                 | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                                | :heavy_minus_sign:                                                                                                                                           | When the workflow execution started processing this file; null while the row is still PENDING                                                                | 2026-09-16T00:00:00Z                                                                                                                                         |
| `queuedAt`                                                                                                                                                   | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                                | :heavy_check_mark:                                                                                                                                           | When the file was queued for this workflow                                                                                                                   | 2026-09-16T00:00:00Z                                                                                                                                         |
