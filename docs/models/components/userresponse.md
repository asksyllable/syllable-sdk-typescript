...
let value: UserResponse = {
  ...
  lastUpdated: new Date("2026-05-10T12:28:22.063Z"),
...
| `utm`                                                                                         | [components.DaoUtm](../../models/components/daoutm.md)                                        | :heavy_minus_sign:                                                                            | Optional UTM campaign attribution to record in user_metadata.                                 |                                                                                               |
