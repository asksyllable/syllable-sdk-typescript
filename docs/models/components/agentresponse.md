...
| `promptVersionNumber`                                                                                                                                                                                                                                                                                                                                                 | *number*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Optional pin to a specific version of the prompt (prompt history version number). When omitted or null, the agent tracks the latest/current version of the prompt. When set, the agent runs that specific prompt version. Must reference an existing version of the agent's prompt.                                                                                   | 3                                                                                                                                                                                                                                                                                                                                                                     |
| `customMessageId`                                                                                                                                                                                                                                                                                                                                                     | *number*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Internal ID of the custom message that should be delivered at the beginning of a conversation with the agent                                                                                                                                                                                                                                                          | 1                                                                                                                                                                                                                                                                                                                                                                     |
| `languageGroupId`                                                                                                                                                                                                                                                                                                                                                     | *number*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Internal ID of the language group associated with the agent                                                                                                                                                                                                                                                                                                           | 1                                                                                                                                                                                                                                                                                                                                                                     |
| `bridgePhrasesId`                                                                                                                                                                                                                                                                                                                                                     | *number*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Internal ID of the bridge phrases config associated with the agent                                                                                                                                                                                                                                                                                                    | 1                                                                                                                                                                                                                                                                                                                                                                     |
| `timezone`                                                                                                                                                                                                                                                                                                                                                            | *string*                                                                                                                                                                                                                                                                                                                                                              | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                    | The time zone in which the agent operates                                                                                                                                                                                                                                                                                                                             | **Example 1:** America/New_York<br/>**Example 2:** America/Chicago                                                                                                                                                                                                                                                                                                    |
...
| `sttProvider`                                                                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Speech-to-text provider for the agent.                                                                                                                                                                                                                                                                                                                                | **Example 1:** Google STT V2 (Chirp 2)<br/>**Example 2:** Deepgram Nova 3 (On-Prem)<br/>**Example 3:** Deepgram Nova 3<br/>**Example 4:** Google STT V2<br/>**Example 5:** Google STT V1<br/>**Example 6:** Deepgram Nova 2                                                                                                                                           |
| `waitSound`                                                                                                                                                                                                                                                                                                                                                           | *string*                                                                                                                                                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Sound to play while waiting for a response from the LLM.                                                                                                                                                                                                                                                                                                              | **Example 1:** No Sound<br/>**Example 2:** Keyboard 1<br/>**Example 3:** Keyboard 2<br/>**Example 4:** Call Center                                                                                                                                                                                                                                                    |
| `enableVerbalLanguageChange`                                                                                                                                                                                                                                                                                                                                          | *boolean*                                                                                                                                                                                                                                                                                                                                                             | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                    | Enables Dynamic Language Switching - when true and a voice group is configured, callers may switch among group languages by speaking at any point in the conversation (in addition to DTMF in response to the language menu).                                                                                                                                         | false                                                                                                                                                                                                                                                                                                                                                                 |
