...
| `toolArguments`                                                                                                                               | Record<string, *components.InsightToolInputToolArguments*>                                                                                    | :heavy_check_mark:                                                                                                                            | Arguments for calling the insight tool                                                                                                        | {<br/>"prompt": "Provide a concise, accurate summary of the conversation's key points, focusing on the user's goal and how the agent responded"<br/>} |
