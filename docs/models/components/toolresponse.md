...
let value: ToolResponse = {
  ...
  lastUpdated: new Date("2025-10-19T14:00:41.613Z"),
...
| `versionNumber`                                                                                              | *number*                                                                                                     | :heavy_check_mark:                                                                                           | Highest tools_history snapshot version for this tool; the tools row defaults to 1.                           | 1                                                                                                            |
| `validationIssues`                                                                                           | [components.ValidationIssue](../../models/components/validationissue.md)[]                                   | :heavy_minus_sign:                                                                                           | Validation issues found in the tool definition. Warnings and infos are informational; errors block the save. |                                                                                                              |