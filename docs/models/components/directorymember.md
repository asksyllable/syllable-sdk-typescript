...
| `comments`                                                                                            | *string*                                                                                              | :heavy_minus_sign:                                                                                    | Optional comment stored in version history for this edit                                              | Updated phone number                                                                                  |
| `createdAt`                                                                                           | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)         | :heavy_check_mark:                                                                                    | When the contact was created                                                                          | 2024-01-01T00:00:00Z                                                                                  |
