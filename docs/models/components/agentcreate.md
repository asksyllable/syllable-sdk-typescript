...
| `variables`                                                                                         | [components.Variables](../../models/components/variables.md)                                        | :heavy_check_mark:                                                                                  | Custom context variables for the conversation session. Keys should be prefixed with "vars.".        |                                                                                                     |
