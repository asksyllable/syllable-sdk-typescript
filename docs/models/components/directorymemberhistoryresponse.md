...
| `operation`                                                                                                          | *string*                                                                                                             | :heavy_minus_sign:                                                                                                   | What produced this row: create, update, delete, restore, bulk_load. Null for rows created before this field existed. | update                                                                                                               |