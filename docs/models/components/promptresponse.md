...
| ~~`tools`~~                                                                                                                                                                                                                             | *string*[]                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                      | : warning: ** DEPRECATED **: This will be removed in a future release, please migrate away from it as soon as possible.<br/><br/>Names of the tools to which the prompt has access (DEPRECATED - use information from full tools field instead) | **Example 1:** hangup<br/>**Example 2:** summary                                                                                                                                                                                        |
...
| `validationIssues`                                                                                                                                                                                                                      | [components.ValidationIssue](../../models/components/validationissue.md)[]                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                      | Non-blocking findings for the saved prompt (e.g. a deprecated model warning). Warnings and infos are informational; errors block the save.                                                                                              |                                                                                                                                                                                                                                         |