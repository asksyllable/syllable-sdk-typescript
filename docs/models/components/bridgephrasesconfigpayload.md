...
| `smartTurnTimeoutSeconds`                                                                                                                                              | *number*                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                     | Seconds of caller silence before injecting the first bridge phrase. When unset, the service-wide default applies.                                                      |                                                                                                                                                                        |
