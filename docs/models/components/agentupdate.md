...
| `variables`                                                                                         | [components.AgentUpdateVariables](../../models/components/agentupdatevariables.md)                  | :heavy_check_mark:                                                                                  | Custom context variables for the conversation session. Should be prefixed with "vars.".             | {<br/>"vars.hospital": "Weill Cornell Medical Center"<br/>}                                         |
