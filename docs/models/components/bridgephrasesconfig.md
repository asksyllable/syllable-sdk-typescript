...
| `metadata`                                                                                                                             | [components.SchemasCortexV1BridgePhrasesDictionaryMetadata](../../models/components/schemascortexv1bridgephrasesdictionarymetadata.md) | :heavy_minus_sign:                                                                                                                     | Metadata for the bridge phrases dictionary.                                                                                            |