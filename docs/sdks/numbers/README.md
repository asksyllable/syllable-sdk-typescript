...
* [channelsTwilioNumbersA2pComplianceCheck](#channelstwilionumbersa2pcompliancecheck) - Verify Twilio Us A2P Compliance
* [add](#add) - Add Twilio Number
* [update](#update) - Update Twilio Number
* [list](#list) - List Twilio Phone Numbers

## channelsTwilioNumbersA2pComplianceCheck

Return whether Twilio shows this number on a US A2P messaging path with an approved brand.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="channels_twilio_numbers_a2p_compliance_check" method="post" path="/api/v1/channels/twilio/{channel_id}/numbers/verify-a2p-compliance" -->
```typescript
...
import { channelsTwilioNumbersChannelsTwilioNumbersA2pComplianceCheck } from "syllable-sdk/funcs/channelsTwilioNumbersChannelsTwilioNumbersA2pComplianceCheck.js";
...
async function run() {
  const res = await channelsTwilioNumbersChannelsTwilioNumbersA2pComplianceCheck(syllableSDK, {
    channelId: 661482,
    a2pMessagingPathCheckRequest: {
      phone: "+18042221111",
    },
  ...
  if (res.ok) {
    ...
    console.log("channelsTwilioNumbersChannelsTwilioNumbersA2pComplianceCheck failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ChannelsTwilioNumbersA2pComplianceCheckRequest](../../models/operations/channelstwilionumbersa2pcompliancecheckrequest.md)                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[components.A2pMessagingPathCheckResponse](../../models/components/a2pmessagingpathcheckresponse.md)\>**
