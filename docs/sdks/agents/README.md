...
* [agentListActiveLabels](#agentlistactivelabels) - List Active Agent Labels
...
* [agentGetAvailableSttProviders](#agentgetavailablesttproviders) - Get Available Agent Stt Providers
* [postCardClickEvent](#postcardclickevent) - Create Card Click Event
...
## agentListActiveLabels

List all distinct labels in use across active agents.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="agent_list_active_labels" method="get" path="/api/v1/agents/labels" -->
```typescript
import { SyllableSDK } from "syllable-sdk";
...
```typescript
import { SyllableSDKCore } from "syllable-sdk/core.js";
import { agentsAgentListActiveLabels } from "syllable-sdk/funcs/agentsAgentListActiveLabels.js";
...
async function run() {
  const res = await agentsAgentListActiveLabels(syllableSDK);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("agentsAgentListActiveLabels failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AgentGetAvailableVoicesRequest](../../models/operations/agentgetavailablevoicesrequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="agent_get_available_stt_providers" method="get" path="/api/v1/agents/stt/available" -->
```typescript
import { SyllableSDK } from "syllable-sdk";
...
async function run() {
  const result = await syllableSDK.agents.agentGetAvailableSttProviders({});
...
```typescript
import { SyllableSDKCore } from "syllable-sdk/core.js";
import { agentsAgentGetAvailableSttProviders } from "syllable-sdk/funcs/agentsAgentGetAvailableSttProviders.js";
...
async function run() {
  const res = await agentsAgentGetAvailableSttProviders(syllableSDK, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("agentsAgentGetAvailableSttProviders failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AgentGetAvailableSttProvidersRequest](../../models/operations/agentgetavailablesttprovidersrequest.md)                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.SupportedSttProvider[]](../../models/.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="post_card_click_event" method="post" path="/api/v1/agents/test/{test_id}/card-click" -->
```typescript
import { SyllableSDK } from "syllable-sdk";
...
async function run() {
  const result = await syllableSDK.agents.postCardClickEvent({
    testId: "<id>",
    cardClickRequest: {
      actionId: "<id>",
      actionType: "action",
...
```typescript
import { SyllableSDKCore } from "syllable-sdk/core.js";
import { agentsPostCardClickEvent } from "syllable-sdk/funcs/agentsPostCardClickEvent.js";
...
async function run() {
  const res = await agentsPostCardClickEvent(syllableSDK, {
    testId: "<id>",
    cardClickRequest: {
      actionId: "<id>",
      actionType: "action",
  ...
  if (res.ok) {
    ...
    console.log("agentsPostCardClickEvent failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PostCardClickEventRequest](../../models/operations/postcardclickeventrequest.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.CardClickResponse](../../models/components/cardclickresponse.md)\>**
